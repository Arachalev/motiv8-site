    ...
    >
      <main>
        <div className={classes.driven}>
          <motion.div
            className={classes.driven1}
            initial={{ scale: 0, opacity: 0.8 }}
            animate={{ scale: 1, opacity: 1, transition: { duration: 2 } }}
          >
            <img src={driven1} alt="Team Image" />
          </motion.div>
          <div className={classes.driven2}>
            {" "}
            <img src={driven2} alt="Team Image" />
          </div>
          ...
          <div className={classes.driven3}>
            <img src={driven3} alt="Team Image" />
          </div>
          <div className={classes.driven4}>
            <img src={driven4} alt="Team Image" />
          </div>
        </div>
      </main>
    </motion.div>
